    ...
    public class UnivariateForecastingSettings
    {
            ...
            )
        {
            ...
            if (forecastingDenominator < DefaultForecastingDenominator)
                throw new ArgumentException(Messages.MessageCollection.UnivariateForecastingSettings_DenominatorCantBeLessThan(nameof(forecastingDenominator), DefaultForecastingDenominator));
